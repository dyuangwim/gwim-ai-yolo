...
def parse_args():
    ...
    ap.add_argument("--weights", default="/home/pi/models/best_ncnn_model")  # 先用原模型
    ap.add_argument("--imgsz", type=int, default=320)  # 先用320
...
def main():
    ...
    try:
        while True:
            ...
            elif len(main_frame.shape) == 2:  # 如果是YUV格式
